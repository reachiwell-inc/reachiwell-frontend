        ...
        <div className="flex flex-col items-center px-6 pt-[88px] pb-16">
          ...
          <div className="w-full max-w-[345px] mb-8">
            <p className="text-[#414747] text-base font-normal leading-normal">
              ...
              <a href="/login" className="text-[#E87954] font-medium hover:underline">
                Log in
              </a>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-[344px]">
            <div className="flex flex-col gap-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="bg-[#E87954] text-white px-6 py-4 rounded-[30px] text-base font-semibold leading-[1.275] w-full h-[60px] flex items-center justify-center hover:bg-[#d66a45] transition-colors mt-10 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? "Creating account..." : success ? "Account Created!" : "Create account"}
              </button>

              {/* Terms and Privacy Disclaimer */}
              <p className="text-[#414747] text-base font-normal leading-normal mt-6 text-left">
                By creating an account, you agree to our{" "}
                <a
                  href="/terms-of-service"
                  className="text-[#E87954] hover:underline"
                >
                  Terms of Service
                </a>
                {" "}and{" "}
