              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className={`w-full px-6 py-4 pr-14 rounded-[30px] border text-[#0B2220] text-base font-normal focus:outline-none focus:ring-2 focus:ring-[#E87954]/20 placeholder:text-[#9CA3AF] ${
